...
public class ProfileValue {
  ...
  public boolean equals(Object o) {
    ...
    ProfileValue that = (ProfileValue) o;
    return qcFlag == that.qcFlag && originatorFlag == that.originatorFlag && Objects.equals(value, that.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(value, qcFlag, originatorFlag);
  }

  @Override
  public String toString() {
    return "ProfileDataValue{" +
        "value=" + value +
        ", qcFlag=" + qcFlag +
